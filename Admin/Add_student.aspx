<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_student.aspx.cs" Inherits="Exam.GUI.Register" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="input-group">
                               ...
                               <asp:TextBox runat="server" maxlength="10" id="nic" type="text" class="form-control" placeholder="NIC No" ></asp:TextBox>
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                                 <asp:TextBox runat="server" id="course" type="text" class="form-control" placeholder="Course ID" ></asp:TextBox>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <asp:TextBox runat="server" id="tp" maxlength="10" Cssclass="form-control" Placeholder="Contact No"></asp:TextBox>
                            </div>
